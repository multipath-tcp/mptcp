 ...
 */
static int mptcpsub_v6_init_sock(struct sock *sk)
{
...
int __init mptcpv6_init(void)
{
	...
	ret = inet6_register_protosw(&mptcpsubv6_protosw);
...
void mptcpv6_exit(void)
{
	inet6_unregister_protosw(&mptcpsubv6_protosw);
}
